...
export class OverviewComponent {
  ...
  courseDescriptionText_2 = "Delve into the intricacies of contract law and tort law, or immerse yourself in the evolving realms of cybersecurity law and technology law.";
  courseDescriptionText_3 = "Whether you're interested in corporate law, family law, or pursuing a career in legal advocacy.";
  courseDescriptionText_4 = "The realm of law learning is an exciting journey filled with boundless opportunities to gain a deeper understanding of justice.";
  courseDescriptionText_5 = "Ethics, and the legal systems that shape our societies.";
  ...
  descriptionText ="A course description provides an overview of what a course covers, while a syllabus provides specific details about the course, such as the schedule, grading criteria, assignments, textbook requirements, and policies";
  ...
  instructorReviewsbySubscriber = "715,505";
