...
@Component({
  selector: 'app-shared-first-homepage',
  templateUrl: './shared-first-homepage.component.html',
  styleUrls: ['./shared-first-homepage.component.scss']
})
export class SharedFirstHomepageComponent implements OnInit {
