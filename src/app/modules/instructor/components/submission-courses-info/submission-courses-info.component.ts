...
@Component({
  selector: 'app-submission-courses-info',
  templateUrl: './submission-courses-info.component.html',
  styleUrls: ['./submission-courses-info.component.scss']
})
export class SubmissionCoursesInfoComponent implements OnInit {
  headings: string[] = [];
