...
@Component({
  selector: 'app-approved-courses-overview',
  templateUrl: './approved-courses-overview.component.html',
  styleUrls: ['./approved-courses-overview.component.scss'],
})
export class ApprovedCoursesOverviewComponent {
