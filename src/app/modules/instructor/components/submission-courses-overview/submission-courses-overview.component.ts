...
@Component({
  selector: 'app-submission-courses-overview',
  templateUrl: './submission-courses-overview.component.html',
  styleUrls: ['./submission-courses-overview.component.scss'],
})
export class SubmissionCoursesOverviewComponent {
