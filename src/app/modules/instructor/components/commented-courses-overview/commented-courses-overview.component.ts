...
@Component({
  selector: 'app-commented-courses-overview',
  templateUrl: './commented-courses-overview.component.html',
  styleUrls: ['./commented-courses-overview.component.scss'],
})
export class CommentedCoursesOverviewComponent {
